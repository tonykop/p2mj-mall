...
/**
 * @author tonyKop
 * @createTime at 2023/07/26 :01:10
 */
public class Constants {

    //public final static String FILE_UPLOAD_DIC = "/opt/image/upload/";//上传文件的默认url前缀，根据部署设置自行修改
    public final static String FILE_UPLOAD_DIC = "G:\\home\\images\\upload\\";//上传文件的默认url前缀，根据部署设置自行修改
    ...
    public final static int SHOPPING_CART_PAGE_LIMIT = 10;//购物车每页限制条数
    ...
    public final static int TOKEN_LENGTH = 32;//token的长度
